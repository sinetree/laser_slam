...
class LaserTrack {
 ...
 public:
  ...
  std::vector<Eigen::VectorXd> saveTrajectory() const {
    std::vector<Eigen::VectorXd> savetraject;
    savetraject = trajectory_.saveCurveTimesAndValues();
    return savetraject;
  }
 ...
 // void computeICPTransformations();
  ...
  PointMatcher1::ICP icp_;

  // ICP input filters.
  PointMatcher1::DataPointsFilters input_filters_;

  // Libpointmatcher rigid transformation.
  PointMatcher1::Transformation* rigid_transformation_;
